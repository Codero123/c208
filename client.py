...
def openChatWindow():
    ...
    labelchat = Label(window, text="chat window", font=("Calibiri", 10))
    labelchat.place(x=10, y=180)

    textarea = Text(window, width=67, height=6, font=("calibiri", 10))
    ...
    attach = Button(window, text="Attach and Send", bd=1, font=("Calibiri", 10))
